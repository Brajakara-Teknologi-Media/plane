      ...
      {distribution && distribution.length > 0 ? (
                ...
                title={
                  <div className="flex items-center gap-2">
                    <div className="h-4 w-4 rounded-full border-2 border-subtle bg-layer-1">
                      <img src={userImage} className="h-full w-full rounded-full object-cover" alt="Username" />
                    </div>
        ...
        <div className="flex h-full flex-col items-center justify-center gap-2">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-layer-1">
            <img src={emptyMembers} className="h-12 w-12 object-contain" alt={t("common.no_members")} />
          </div>
