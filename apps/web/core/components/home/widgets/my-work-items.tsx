    ...
    <div className="rounded-xl border border-subtle bg-surface-1 p-4">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-13 font-semibold">My work items</span>
        </div>
        <Link
      ...
      {items.length === 0 && <p className="py-4 text-center text-13 text-secondary">No work items assigned to you.</p>}
          ...
          <div key={issue.id} className="flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-surface-2">
            ...
            {issue.state_detail?.name && (
              <span
                ...
                style={{
                  backgroundColor: (issue.state_detail.color ?? "#888") + "22",
