            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-11 text-tertiary">
                  This detailed error view only appears in development. In production, users will see a
                  friendly error page.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-md bg-layer-1 p-4">
              <p className="text-13 text-secondary">
                An unknown error occurred. Try refreshing the page or contact support if the problem
                persists.
              </p>
            </div>
